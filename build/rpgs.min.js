	  ...
	  return function (_get__2) {
	    ...
	    _createClass(CompoundNode, [{
	      ...
	      value: function addChild(data) {
	        var child = this.nodePool.addNode(data);
	        var children = _children.get(this);
	
	        // console.log('addChild',child.getId());
	        if (child !== null) {
	          _children.set(this, _get__('Utils').addObjectToArray(children, child.getId()));
	        }
	        return child;
	      }
	    }, {
	...
	var DialogNode = function () {
	  ...
	  return function (_get__2) {
	    ...
	    _createClass(DialogNode, [{
	      ...
	      key: 'addChild',
	      value: function addChild(childId) {
	        var child = _get(DialogNode.prototype.__proto__ || Object.getPrototypeOf(DialogNode.prototype), 'addChild', this).call(this, childId);
	        var children = this.getChildren();
