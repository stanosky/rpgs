...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseNode = function () {
	  ...
	  var getRandomLabel = function getRandomLabel(prefix, id) {
	    return prefix + id.substr(0, 4);
	  };
	  ...
	  return function () {
	    function BaseNode(nodePool, data) {
	      ...
	      var prefix = className.substr(0, className.indexOf('Node')) + '-';
	
	      _label.set(this, _data.label ? _data.label : getRandomLabel(prefix, _uuid.get(this)));
	    ...
	    _createClass(BaseNode, [{
	      ...
	      key: 'addChild',
	      value: function addChild(params) {
	        // empty because cannot have children
	      }
	    }, {
	      key: 'setNodeAsChild',
	      value: function setNodeAsChild(node) {
	        // empty because cannot have children
	      }
	    }, {
	      key: 'removeChild',
	...
	var ConnectorManager = function () {
	  ...
	  return function () {
	    ...
	    _createClass(ConnectorManager, [{
	      ...
	      key: 'removeWiresTo',
	      value: function removeWiresTo(nodeId) {
	        var connectors = _connectors.get(this) || null;
	
	        if (connectors !== null) {
	          connectors.forEach(function (c) {
	            return c.removeWire(nodeId);
	          });
	        }
	      }
	    }, {
	  ...
	  return function (_get__2) {
	    ...
	    _createClass(CompoundNode, [{
	      ...
	      value: function getData() {
	        ...
	        data.children = this.getChildren().map(function (child) {
	          return child.getId();
	        });
	        return data;
	      }
	      ...
	      key: 'setNodeAsChild',
	      value: function setNodeAsChild(node) {
	        var canSetAsChild = node !== null && this.canAddChild(node.getData().class);
	        var children = _children.get(this);
	
	        // console.log('addChild',child.getId());
	        if (canSetAsChild) {
	          _children.set(this, _get__('Utils').addObjectToArray(children, node.getId()));
	        }
	      ...
	      value: function addChild(data) {
	        var canSetAsChild = data && data.class ? this.canAddChild(data.class) : false;
	        var child = canSetAsChild ? this.nodePool.addNode(data) : null;
	      ...
	      value: function getChildren() {
	        ...
	        if (children !== undefined) {
	          ret = children.map(function (childId) {
	            return _this2.nodePool.findNode(childId);
	          });
	        }
	        return ret;
	      }
	      ...
	      key: 'setChildIndex',
	      value: function setChildIndex(childId, newIndex) {
	        var children = _children.get(this);
	        var len = children.length;
	        var oldIndex = children.indexOf(childId);
	      ...
	      value: function dispose() {
	        ...
	        _children.get(this).map(function (childId) {
	          _this3.nodePool.removeNode(childId);
	        });
	...
	var DialogNode = function () {
	  ...
	  return function (_get__2) {
	    ...
	    _createClass(DialogNode, [{
	      ...
	      key: 'setNodeAsChild',
	      value: function setNodeAsChild(node) {
	        var canSetAsChild = _get(DialogNode.prototype.__proto__ || Object.getPrototypeOf(DialogNode.prototype), 'setNodeAsChild', this).call(this, node);
	        var children = this.getChildren();
	      ...
	      value: function removeChild(index) {
	        ...
	        var talkId = child !== null ? child.getId() : '';
	        var startTalk = this.getStartTalk();
	      ...
	      value: function setStartTalk(talkId) {
	        ...
	        var children = this.getChildren();
	        var childExist = _get__('Utils').getIndexById(children, talkId) > -1;
	  ...
	  return function () {
	    ...
	    _createClass(DialogWalker, [{
	      ...
	      value: function getConversation() {
	        ...
	        conversation.options = children.map(function (answer) {
	          return {
	            id: answer.getId(),
	            text: answer.getText(),
	      ...
	      value: function selectOption(id) {
	        ...
	        var answer = children.filter(function (child, index, array) {
	          return child.getId() === id;
	        });
	
	        if (answer[0] !== undefined) {
	          var answerNode = answer[0];
	          var talkId = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RPGSystem = function RPGSystem() {
	  ...
	  var _errorHandler = new (_get__('ErrorHandler'))();
	  var _nodeFactory = new (_get__('NodeFactory'))(_errorHandler);
	  var _nodePool = new (_get__('NodePool'))(_nodeFactory, _errorHandler);
	  var _nodeCreator = new (_get__('NodeCreator'))(_nodePool, _errorHandler);
	
	  function _mergeNodes(data) {
	    var _data = data || '[]';
	
	    JSON.parse(_data).forEach(function (d) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NodePool = function NodePool(nodeFactory, errorHandler) {
	  var _nodeFactory = nodeFactory;
	  ...
	  function addNode(params) {
	    var node = _nodeFactory.createNode(this, params);
	  ...
	  function removeNode(id) {
	    var clearDeadWires = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
	    ...
	    if (isNodeFound) {
	      ...
	      node.dispose();
	      if (clearDeadWires) {
	        _objectPool.forEach(function (node) {
	          return node.cm.removeWiresTo(id);
	        });
	      }
	    }
	    return isNodeFound;
	  ...
	  function getData() {
	    return _objectPool.map(function (obj) {
	      return obj.getData ? obj.getData() : obj;
	    });
	  }
	
	  function clearData() {
	    _objectPool.forEach(function (obj) {
	      return obj.dispose();
	    });
	    _objectPool = [];
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NodeFactory = function NodeFactory(errorHandler) {
	  ...
	  function _createNode(nodePool, data) {
	    ...
	    switch (className) {
	      case 'BaseNode':
	        return new (_get__('BaseNode'))(nodePool, data);
	      case 'AnswerNode':
	        return new (_get__('AnswerNode'))(nodePool, data);
	      case 'DialogNode':
	        return new (_get__('DialogNode'))(nodePool, data);
	      case 'TalkNode':
	        return new (_get__('TalkNode'))(nodePool, data);
	      default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NodeCreator = function NodeCreator(nodePool, errorHandler) {
